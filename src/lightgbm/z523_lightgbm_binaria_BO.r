...
PARAM$input$dataset <- "./datasets/competencia_02.csv" #cambié por csv
...
PARAM$hyperparametertuning$semilla_azar <- 594421
#------------------------------------------------------------------------------
...
hs <- makeParamSet(
  ...
  makeIntegerParam("envios", lower = 11000L, upper = 13000L) #acoté el rango 
)
